 ...
 */
const msgTitle = (msg) => console.log(chalk.bgBlue(chalk.white(msg + "\n")));
 ...
 */
const msgNormal = (msg) => console.log(msg);
 ...
 */
const msgInfo = (msg) => console.log(chalk.cyan(msg));
 ...
 */
const msgSuccess = (msg) => console.log(chalk.green(msg + "\n"));
 ...
 */
const msgError = (msg) => console.log(chalk.red(msg + "\n"));
